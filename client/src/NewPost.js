...
function NewPost() {
    ...
    {
        // suspends default behavior
        // allows to do 2 things
        // uploada image and and 
        // gather form data
        e?.preventDefault();
    ...
    const createPost = (imageUrl) => {
        // note the labels/index-names are 
        // json that fastapi passes up with 
        ...
        const requestOptions = {
            ...
            // consume requestOptions (the json we wannt to send back)
